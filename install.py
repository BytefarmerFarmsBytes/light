...
"/usr/share/pixelmap/lightbar.png", #app icon
"/bin/lightui", #yad ui for the light changer
"/usr/share/applications/light.desktop", #application launcher for the yad ui
...
#start locations
start = [
"files/lightbar.png", #app icon
"files/lightui", #yad ui for the light changer
"files/light.desktop", #application launcher for the yad ui
